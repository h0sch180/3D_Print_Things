...
#define CUSTOM_MACHINE_NAME "Anycubic i3 Mega X"
...
#define USE_XMAX_PLUG		// AI3M used as the second z stepper end limit switch
 ...
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2...]]
                                        AI3M-S default 384 after calibrate 393.86
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 393.86 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 120, 6, 30 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, -15, -3.90 }
...
#define INVERT_E0_DIR true // set to true for stock drivers or TMC2208 with reversed connectors
#define INVERT_E1_DIR true // set to true for stock drivers or TMC2208 with reversed connectors
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the number of grid points per dimension.	MAX_POINTS 3 = 9 GRID Points
